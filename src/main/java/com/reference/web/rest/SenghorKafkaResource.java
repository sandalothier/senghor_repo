...
@RestController
@RequestMapping("/api/senghor-kafka")
public class SenghorKafkaResource {
    private final Logger log = LoggerFactory.getLogger(SenghorKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public SenghorKafkaResource(KafkaProperties kafkaProperties) {
